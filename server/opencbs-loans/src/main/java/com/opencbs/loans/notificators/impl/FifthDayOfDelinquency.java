...
@Service
public class FifthDayOfDelinquency implements LoanRemember {

    private final static Integer DAYS_OF_DELINQUENCY = 5;
    ...
    public LoanRememberType getType() {
        return LoanRememberType.FIFTH_DAY_OF_DELINQUENCY;
    }
    ...
    public String getTitle() {
        return "Fifth day of delinquency";
    }
