...
@Table(name = "branch_custom_fields_values")
@Data
public class BranchCustomFieldValue extends CustomFieldValue<BranchCustomField> {
    ...
    public boolean equals(Object o) {
        ...
        BranchCustomFieldValue that = (BranchCustomFieldValue) o;
