...
@Table(name = "companies_custom_fields_values")
@Data
public class CompanyCustomFieldValue extends CustomFieldValue<CompanyCustomField> {
    ...
    public boolean equals(Object o) {
        ...
        CompanyCustomFieldValue that = (CompanyCustomFieldValue) o;
