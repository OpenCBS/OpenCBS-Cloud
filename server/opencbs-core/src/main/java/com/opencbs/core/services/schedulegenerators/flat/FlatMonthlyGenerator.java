...
@Component
public class FlatMonthlyGenerator extends AbstractFlatGenerator {
    ...
    @Autowired
    protected FlatMonthlyGenerator(@NonNull HolidayService holidayService) {
        super(holidayService, 1, DAYS_IN_YEAR);
    }
    ...
    public ScheduleGeneratorTypes getType() {
        return ScheduleGeneratorTypes.FLAT_MONTHLY;
    }
