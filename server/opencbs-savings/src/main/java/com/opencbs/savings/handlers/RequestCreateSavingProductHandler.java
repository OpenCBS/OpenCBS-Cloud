...
@Service
public class RequestCreateSavingProductHandler implements RequestHandler {

    private final ObjectMapper mapper;
    private final SavingProductMapper savingProductMapper;
    private final SavingProductService savingProductService;

    public RequestCreateSavingProductHandler(ObjectMapper mapper,
    ...
    public RequestType getRequestType() {
        return RequestType.SAVING_PRODUCT_CREATE;
    }
    ...
    public Long approveRequest(Request request) throws IOException {
        SavingProduct savingProduct = this.savingProductService.create(this.createEntity(request));
